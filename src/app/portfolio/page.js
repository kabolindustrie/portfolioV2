...
const items = [
    ...
    desc: (
      <div>
        <p>
          ...
          React, offrant une expérience utilisateur fluide et réactive pour les
          acheteurs en ligne.
        </p>
        <p>
          • Utilisation de <strong>React </strong>et
  ...
  },
  {
    ...
    desc: (
      <div>
        <p>
          •Plateforme de réservation en ligne pour les salons de coiffure,
          L&lsquo;accent est mis sur la simplicité et l&lsquo;efficacité,
          permettant aux clients de réserver des rendez-vous en quelques clics
        </p>
        <p>
          • Utilisation de <strong>Js, React </strong>et
          <strong> Tailwind CSS</strong>.
        </p>
      </div>
    ),
  ...
  },
  {
    ...
    desc: (
      <div>
        <p>
        •Application visant à simplifier la création de conteneurs HTML en générant un code CSS complet.
        </p>
        <p>
          • Utilisation de <strong>React, Redux </strong>et
          <strong> Tailwind CSS</strong>.
        </p>
      </div>
    ),
    img: Mockup1,
    link: "https://box-generator.web.app/",
    target: "_blank",
  },
  // {
  //   id: 4,
      ...
      <div className="h-[600vh]" ref={ref}>
        ...
        <div className="sticky top-0 flex h-screen gap-1 items-center overflow-hidden">
          <motion.div style={{ x }} className="flex">
            <div className="h-screen w-screen flex items-center justify-center gap-32 bg-gradient-to-r from-purple-100 to-red-100" />
            {items.map((item) => (
              <div
              ...
              >
                <div className="flex flex-col gap-5 text-black m-8">
                  ...
                  <div className="relative w-64 h-64 md:w-96 md:h-96 lg:w-[500px] lg:h-[350px]">
